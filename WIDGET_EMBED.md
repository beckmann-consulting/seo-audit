...
Das Widget führt einen Mini-SEO-Audit direkt auf einer Fremd-Website durch und zeigt Score, Top-3-Handlungsempfehlungen und einen CTA zum vollständigen Audit auf beckmanndigital.com.
...
Das Script findet automatisch das Container-Element, baut einen iframe und verdrahtet die dynamische Höhenanpassung via `postMessage`.
...
- Das Widget lädt sich als iframe aus `/widget?lang=<code>`.
- Die Audit-API (`/api/widget/audit`) ist per CORS auf
